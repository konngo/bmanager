...
//  showNotify('top', 'center', "primary","title","message");
var showNotify=null;
...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    // 修改alert按钮
    // 添加 data-title data-message 显示信息内容
    // <a href="#" class="btn btn-outline-primary rounded notify-btn mb-1" data-from="top" data-title="success" data-message="that is good" data-align="center">Top Center</a>

    $("body").on("click", ".notify-btn", function (event) {
      event.preventDefault();
      showNotification($(this).data("from"), $(this).data("align"), "primary",$(this).data("title"),$(this).data("message"));
    });
